...
<html lang="en">
    ...
    // Key_input.name = "key[" + current_attribute + "]";
    // Key_input.value = "Name of additional attribute";
    // Value_input.name = "value[" + current_attribute + "]";
    // Value_input.value = "Value of additional attribute";
    // Key_label.for = "key[" + current_attribute + "]";
    // Key_label.value = "Name: ";
    // Value_label.for = "value[" + current_attribute + "]";
